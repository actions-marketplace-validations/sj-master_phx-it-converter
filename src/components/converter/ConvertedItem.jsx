      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          <div
            ...
            className="flex-shrink-0 rounded-lg overflow-hidden border border-primary/20 flex items-center justify-center cursor-pointer hover:border-primary/50 hover:scale-110 transition-all duration-200"
            style={{
